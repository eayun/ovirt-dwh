...
package ovirt_engine_dwh.aggregationtohourly_3_5;
	...
	public void tJDBCInput_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbquery_tJDBCInput_6 = " SELECT DISTINCT var_name, var_datetime FROM history_configuration WHERE var_name = 'lastHourAggr' ";
					...
					while (rs_tJDBCInput_6.next()) {
						...
						if (colQtyInRs_tJDBCInput_6 < column_index_tJDBCInput_6) {
							...
							if (tmpContent_tJDBCInput_6 != null) {
								row11.key = tmpContent_tJDBCInput_6;
							} else {
								row11.key = null;
							}
						...
						if (colQtyInRs_tJDBCInput_6 < column_index_tJDBCInput_6) {
							...
							tmpContent_tJDBCInput_6 = rs_tJDBCInput_6
									.getString(column_index_tJDBCInput_6);
							if (tmpContent_tJDBCInput_6 != null) {
								row11.value = tmpContent_tJDBCInput_6;
							} else {
								row11.value = null;
							}
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class tRowGenerator_1Randomizer {
					...
					public java.util.Date getRandomvar_datetime() {
						...
						return TalendDate
								.addDate(context.lastHourAggr, 1, "HH");
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					row18.var_name = randtRowGenerator_1.getRandomvar_name();

					row18.var_datetime = randtRowGenerator_1
					...
					if (row18.var_datetime != null) {
						pstmt_tJDBCOutput_6.setTimestamp(
								1,
								new java.sql.Timestamp(row18.var_datetime
										.getTime()));
					} else {
						pstmt_tJDBCOutput_6.setNull(1, java.sql.Types.DATE);
					}

					if (row18.var_name == null) {
						pstmt_tJDBCOutput_6.setNull(2, java.sql.Types.VARCHAR);
					} else {
						pstmt_tJDBCOutput_6.setString(2, row18.var_name);
					}
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class AggOperationStruct_tAggregateRow_8 { // G_OutBegin_AggR_100
					...
					Integer vm_configuration_version_last;
					Integer current_host_configuration_version_last;
					Integer user_logged_in_to_guest_last;
				...
				try {
					...
					while (rs_tJDBCInput_10.next()) {
						...
						if (colQtyInRs_tJDBCInput_10 < column_index_tJDBCInput_10) {
							row13.current_user_id = null;
						} else {

							if (rs_tJDBCInput_10
									.getObject(column_index_tJDBCInput_10) != null) {
								row13.current_user_id = rs_tJDBCInput_10
						...
						{ // start of Var scope
							...
							vm_users_aggregate_history_tmp.user_id = row13.current_user_id;
						...
						if (vm_users_aggregate_history != null) {
							...
							operation_finder_tAggregateRow_8.user_id = vm_users_aggregate_history.user_id;
							...
							if (vm_users_aggregate_history.vm_client_ip != null) { // G_OutMain_AggR_546
							...
							if (vm_users_aggregate_history.user_logged_in_to_guest != null) { // G_OutMain_AggR_546

								operation_result_tAggregateRow_8.user_logged_in_to_guest_last = vm_users_aggregate_history.user_logged_in_to_guest;
				...
				for (AggOperationStruct_tAggregateRow_8 aggregated_row_tAggregateRow_8 : values_tAggregateRow_8) { // G_AggR_600
					...
					{ // start of Var scope
						...
						complete_aggregation_tmp.user_id = row14.user_id;
						complete_aggregation_tmp.user_name = row14.user_name;
						complete_aggregation_tmp.user_logged_in_to_guest = row14.user_logged_in_to_guest != null ? row14.user_logged_in_to_guest > 0
								: null;
					...
					if (complete_aggregation != null) {
						...
						if (complete_aggregation.user_id == null) {
							pstmt_tJDBCOutput_10.setNull(2,
									java.sql.Types.OTHER);
						} else {
							pstmt_tJDBCOutput_10.setObject(2,
									complete_aggregation.user_id);
						}
						...
						pstmt_tJDBCOutput_10.setDouble(6,
		...
		try {
			...
			java.io.InputStream inContext = AggregationToHourly.class
					.getClassLoader().getResourceAsStream(
							"ovirt_engine_dwh/aggregationtohourly_3_5/contexts/"
